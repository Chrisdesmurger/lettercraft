...
export const questionsByCategory: Record<string, Question[]> = {
  developer: [
    ...
    },
    {
      ...
      placeholder:
        "Décrivez brièvement le contexte, les technologies utilisées et l'impact...",
      required: true,
    },
    {
      id: "problem_solving",
      ...
      placeholder:
        "Détaillez le problème rencontré, votre approche et le résultat obtenu...",
      required: true,
    },
    {
      id: "learning_culture",
      ...
      placeholder:
        "Ex: Je suis des blogs tech, participe à des meetups, contribue à l'open source...",
      required: true,
    },
    {
      id: "career_goals",
      ...
      placeholder:
        "Ex: Architecture scalable, IA/ML, performance, nouvelles technologies...",
      required: true,
    },
  ],
  designer: [
