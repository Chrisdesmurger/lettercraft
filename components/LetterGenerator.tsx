...
export default function LetterGenerator({
  ...
  const [toneKey, setToneKey] = useState<ToneKey>(
    data?.letterToneKey || "professionnel",
  );
  const [customToneText, setCustomToneText] = useState(
    data?.letterToneCustom || "",
  );
    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-12">
        ...
        >
          ...
          <p className="text-gray-600">{t("letter.generatingDesc")}</p>
        ...
        <Card className="p-8">
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 mb-6">{t("letter.customizeDesc")}</p>
            </div>
            ...
            <div>
              ...
              <RadioGroup
                value={toneKey}
                onValueChange={(value) => setToneKey(value as ToneKey)}
              >
