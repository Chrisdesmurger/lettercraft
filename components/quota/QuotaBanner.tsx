...
export function QuotaBanner({
  ...
  if (isExceeded) {
    ...
    description =
      t("quota.messages.quotaExceeded", { max: quota.max_letters }) +
      ". " +
      t("quota.messages.comeBackIn", {
        time: quotaUtils.getTimeUntilReset(
          quota.reset_date,
          quota.first_generation_date,
        ),
      });
    actionButton = (
    ...
    title = t("quota.free");
    description = t("quota.messages.freePlanInfo", {
      count: quota.remaining_letters,
    });
    actionButton = (
