      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">{t("account.deletion.subtitle")}</p>
          </div>
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-6">
                  ...
                  <label className="flex items-start space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">
                        {t("account.deletion.hardDelete")}
                      </div>
                      <div className="text-sm text-gray-600">
                        {t("account.deletion.hardDeleteDescription")}
                      </div>
                    </div>
                  </label>
                  <label className="flex items-start space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">
                        {t("account.deletion.softDelete")}
                      </div>
                      <div className="text-sm text-gray-600">
                        {t("account.deletion.softDeleteDescription")}
                      </div>
                    </div>
                  </label>
                </div>
              ...
              <div className="space-y-3">
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <div className="text-sm">
                    <div className="font-medium text-gray-900">
                      {t("account.deletion.acknowledgeTitle")}
                    </div>
              ...
              <div className="flex justify-between pt-4">
                ...
                >
                  ...
                  <span>
                    {loading
                      ? t("account.deletion.processing")
                      : t("account.deletion.confirmButton")}
                  </span>
                </button>
              </div>
            </form>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  <div className="flex items-center justify-center mb-3">
                    ...
                    <h3 className="font-semibold text-blue-800">
                      {t("account.deletion.emailSentTitle")}
                    </h3>
                  </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                <div className="flex items-center justify-center mb-3">
                  ...
                  <h3 className="font-semibold text-yellow-800">
                    {t("account.deletion.scheduledTitle")}
                  </h3>
                </div>
                <p className="text-yellow-700 text-sm mb-2">
                  {t("account.deletion.scheduledDescription", {
                    date: formatDate(deletionRequest.scheduledDeletionAt),
                  })}
                </p>
