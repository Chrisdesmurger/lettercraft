    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 400 && result.error.includes("expiré")) {
          ...
          setState("error");
          setError(
            result.error || t("account.deletion.confirm.confirmationError"),
          );
        }
        return;
      }
          ...
          {state === "success" && deletionInfo && (
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Votre demande de suppression de compte a été confirmée avec
                  succès.
                </p>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                ...
                <p className="text-red-700 text-sm mb-2">
                  ...
                  <strong>
                    {formatDate(deletionInfo.scheduledDeletionAt)}
                  </strong>
                </p>
                <p className="text-red-700 text-sm">
                  Suppression prévue{" "}
                  <strong>
                    {getTimeRemaining(deletionInfo.scheduledDeletionAt)}
                  </strong>
                </p>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                ...
                <p className="text-yellow-700 text-sm mb-3">
                  Vous disposez encore de temps pour changer d'avis et annuler
                  la suppression.
                </p>
                <button
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <ul className="text-blue-700 text-sm space-y-1 text-left">
                  ...
                  <li>
                    • Votre abonnement (avec remboursement pro rata si
                    applicable)
                  </li>
                </ul>
                <p className="text-blue-700 text-sm mt-3 font-medium">
                  Seules vos factures seront conservées de manière anonymisée
                  (obligation légale).
                </p>
              </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  {error ||
                    "Une erreur est survenue lors de la confirmation de votre demande."}
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                ...
                <ul className="text-gray-700 text-sm space-y-2 text-left">
                  <li>
                    • Vérifiez que le lien n'est pas tronqué dans votre email
                  </li>
                  <li>• Copiez-collez l'URL complète dans votre navigateur</li>
                  <li>
                    • Vérifiez que vous utilisez le bon navigateur/appareil
                  </li>
          ...
          {state === "expired" && (
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Ce lien de confirmation a expiré. Les liens de confirmation
                  sont valides pendant 7 jours.
                </p>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <p className="text-blue-700 text-sm">
                  Vous devez refaire une nouvelle demande de suppression de
                  compte pour obtenir un nouveau lien de confirmation.
                </p>
              </div>
