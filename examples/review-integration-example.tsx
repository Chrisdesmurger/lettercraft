...
export function LetterPreviewWithReviews({ letter }: { letter: { id: string; content: string } }) {
  return (
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          {badge.earned && (
            <ContributorBadge badge={badge} size="sm" />
          )}
        </CardHeader>
        <CardContent>
          <div className="whitespace-pre-wrap">{letter.content}</div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Vue d'ensemble des avis et feedback utilisateurs</p>
      </div>
